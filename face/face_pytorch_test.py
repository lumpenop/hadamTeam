...
if __name__ == '__main__':
    ...
    r = predict_face_from_file('kya2.jpg', embedding_vector_dict, fast_mtcnn, model_embedding)
    print('embeddings predict:', r)

    r = predict_face_from_file('b2.jpg', embedding_vector_dict, fast_mtcnn, model_embedding)
    print('embeddings predict:', r)

    r = predict_face_from_file('y2.jpg', embedding_vector_dict, fast_mtcnn, model_embedding)
    print('embeddings predict:', r)

    r = predict_face_from_file('sharon.jpg', embedding_vector_dict, fast_mtcnn, model_embedding)
    print('embeddings predict:', r)

    r = predict_class_face_from_file('kya2.jpg', fast_mtcnn, model)
    print('predict_class predict:', r)